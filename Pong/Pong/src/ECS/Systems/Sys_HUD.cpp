...
void Sys_HUD::Setup(const int width, const int height) {
	...
	m_leftSpecialBar.SetPosition(sf::Vector2f(10.0f, 40.0f));
	...
	m_rightSpecialBar.SetPosition(sf::Vector2f(static_cast<float>(width - 10) - specialBarWidth, 40.0f));
